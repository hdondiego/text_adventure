...
public class Building {
	...
	// this had to be adjusted to work for this game
	// I understand that this isn't good for reusing the code
	public void addRoom(String startFrom, String dir, String newRoomName, String desc, String posHealthNarr, String negHealthNarr, int posHealthEffect, int negHealthEffect) {
		Room startRoom = findRoomByName(startFrom);
		if (startRoom != null) {
			startRoom.setNeighbor(dir, new Room(newRoomName,desc,posHealthNarr,negHealthNarr,posHealthEffect,negHealthEffect));
		}
	}
	/**
